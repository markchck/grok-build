...
from docagent.tracing import SpanKind, set_output, set_retrieval_documents, traced_span
...
def dense_search(
    ...
    *,
    ...
    with traced_span(
        ...
        name = collection_name or get_settings().milvus_collection
        client = get_client()
        ...
        set_retrieval_documents(span, hits)
...
def sparse_search(
    ...
    *,
    ...
    with traced_span(
        ...
        kind=SpanKind.RETRIEVER,
        input_value=query,
        attributes={"retrieval.mode": "sparse", "retrieval.top_k": limit},
    ) as span:
        name = collection_name or get_settings().milvus_collection
        client = get_client()
        ensure_loaded(client, name)
